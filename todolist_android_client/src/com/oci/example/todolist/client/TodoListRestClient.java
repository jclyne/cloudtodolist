...
public final class TodoListRestClient {
    ...
    // URL of the todolist entries resource
     ...
     * Certain api requests return a list of todolist entries as well as a
    ...
    public class EntryListResponse extends Response {
        ...
        // List of todolist entries in the response
        ...
        /**
         * @return list of todolist entries in the response
         */
    ...
    /**
     * Deletes a todolist entry via HTTP delete request
     *
