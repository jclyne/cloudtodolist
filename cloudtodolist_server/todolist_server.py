...
class EntryListHandler(webapp.RequestHandler):
    ...
    @update_timestamp
    def get(self):
        """Retrieves the list of cloudtodolist entries,
    ...
    @update_timestamp
    def post(self):
        """Creates a new cloudtodolist entry
        ...
        try:
            ...
            self.response.out.write(body)
            send_update(users.get_current_user().user_id(),body)
    ...
    def delete(self):
        ...
        Query String Params:
            id - entry id to delete
                ...
                NOTE: If omitted, all cloudtodolist entries will be deleted
        ...
        if ids:
            for id in ids:
                ...
                if entry:
                    send_update(users.get_current_user().user_id(),encode_json(entry.to_dict()))
        else:
...
class ChannelHandler(webapp.RequestHandler):
    ...
    def get (self):
        ...
        token = channel.create_channel(user.user_id()+"_"+remote_addr+"_"+str(now))
